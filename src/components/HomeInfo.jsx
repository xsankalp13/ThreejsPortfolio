...
const renderContent = {
    1: (
        <h1 className='sm:text-xl sm:leading-snug text-center neo-brutalism-blue py-4 px-8 text-white mx-5'>
            Hi, I am <span className='font-semibold'>Sankalp</span> 👋
            <br/>
    ...
    3: (
        <InfoBox text="Completed multiple projects successfully. Curious about the impact?" link="/projects" btnText="Visite My Portfolio"/>
